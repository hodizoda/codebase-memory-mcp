...
[![License](https://img.shields.io/badge/license-MIT-green)](https://github.com/hodizoda/codebase-memory-mcp/blob/main/LICENSE)
...
See [github.com/hodizoda/codebase-memory-mcp](https://github.com/hodizoda/codebase-memory-mcp) for the full README including all MCP tools, configuration options, graph data model, and language support details.

...
[![Tests](https://img.shields.io/badge/tests-6768_passing-brightgreen)](https://github.com/hodizoda/codebase-memory-mcp)
[![Languages](https://img.shields.io/badge/languages-158-orange)](https://github.com/hodizoda/codebase-memory-mcp)
[![Hybrid LSP](https://img.shields.io/badge/Hybrid_LSP-10_languages-blue)](#hybrid-lsp)
[![Agents](https://img.shields.io/badge/agent_surfaces-43-purple)](https://github.com/hodizoda/codebase-memory-mcp)
[![Pure C](https://img.shields.io/badge/pure_C-no_language_runtime-blue)](https://github.com/hodizoda/codebase-memory-mcp)
...
[![VirusTotal](https://img.shields.io/badge/VirusTotal-scanned_every_release-brightgreen?logo=virustotal)](https://github.com/hodizoda/codebase-memory-mcp/releases/latest)
...
```bash
curl -fsSL https://raw.githubusercontent.com/hodizoda/codebase-memory-mcp/main/install.sh | bash
```
...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/hodizoda/codebase-memory-mcp/main/install.ps1 -OutFile install.ps1
...
1. **Download** the archive for your platform from the [latest release](https://github.com/hodizoda/codebase-memory-mcp/releases/latest):
...
- **SLSA Level 3** — cryptographic build provenance generated by the trusted GitHub Actions build workflow; verify with `gh attestation verify <file> --repo hodizoda/codebase-memory-mcp --signer-workflow hodizoda/codebase-memory-mcp/.github/workflows/_build.yml`

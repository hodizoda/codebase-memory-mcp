...
This package installs the `codebase-memory-mcp` binary from [GitHub Releases](https://github.com/hodizoda/codebase-memory-mcp/releases). The binary is downloaded on first run and cached in your OS cache directory.
